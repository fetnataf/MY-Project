<%-- 
    Document   : OrderForm
    Created on : 23-Sep-2017, 2:02:40 PM
    Author     : fetnat
--%>
...
@media screen and (min-width: 768px) {
  ...
  .jumbotron {
    ...
    <body>
       <div class="container">
    <h1 class="well">Billing Address Form</h1>
	<div class="col-lg-12 well">
	<div class="row">
				<form:form method="POST" action="BillingProcess/${login.username}" modelAttribute="billingaddress">
					<div class="col-sm-12">
						<div class="row">
